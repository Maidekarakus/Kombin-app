  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-teal-400 to-blue-500">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <input type="password" placeholder="Şifre" className="w-full p-2 mb-6 border border-gray-300 rounded" />
        <button className="w-full bg-teal-500 text-white p-2 rounded">Giriş Yap</button>
      </div>
    </div>
  );
}